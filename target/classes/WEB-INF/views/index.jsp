                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/1.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post wow fadeInUp" data-wow-delay=".4s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/2.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post wow fadeInUp" data-wow-delay=".6s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/3.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post wow fadeInUp" data-wow-delay=".8s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/4.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12">
                            <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".2s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/6.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12">
                            <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".4s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/7.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12">
                            <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".6s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/8.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12">
                            <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".8s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="/resources/yummy/img/blog-img/9.jpg" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                    ...
                    <div class="blog-sidebar mt-5 mt-lg-0">
                        ...
                        <div class="single-widget-area about-me-widget text-center">
                            ...
                            <div class="about-me-widget-thumb">
                                <img src="/resources/yummy/img/about-img/1.jpg" alt="">
                            </div>
                        ...
                        <div class="single-widget-area popular-post-widget">
                            ...
                            <div class="single-populer-post d-flex">
                                <img src="/resources/yummy/img/sidebar-img/1.jpg" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="/resources/yummy/img/sidebar-img/2.jpg" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="/resources/yummy/img/sidebar-img/3.jpg" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="/resources/yummy/img/sidebar-img/4.jpg" alt="">
                                <div class="post-content">
                                    <a href="#">
                            ...
                            <!-- Single Popular Post -->
                            <div class="single-populer-post d-flex">
                                <img src="/resources/yummy/img/sidebar-img/5.jpg" alt="">
                                <div class="post-content">
                                    <a href="#">
