						...
						<nav aria-label="#">
							<ul class="pagination">
								<li class="page-item"><c:if test="${page.prev}">
										<a class="page-link"
											href="projectlist?currPage=${page.startBlock-1 }&search=${search}&searchtxt=${searchtxt}">이전</a>
									</c:if></li>
								...
								<c:forEach var="i" begin="${page.startBlock}"
									...
									<li class="page-item"><a class="page-link"
										href="projectlist?currPage=${i }&searchtxt=${searchtxt }"><c:out
												value="${i }" /></a></li>
								...
								<li class="page-item"><c:if test="${page.next}">
										<a class="page-link"
											href="projectlist?currPage=${page.endBlock+1 }&search=${search}&searchtxt=${searchtxt}">다음</a>
									</c:if></li>
